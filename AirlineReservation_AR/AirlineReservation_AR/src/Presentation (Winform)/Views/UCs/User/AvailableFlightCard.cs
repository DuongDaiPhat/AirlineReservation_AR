...
{
    public partial class AvailableFlightCard : Guna2Panel
    {
        // Sự kiện chọn 1 chuyến
        public event Action<AvailableFlightDto>? OnSelected;

        private AvailableFlightDto _dto;

        public AvailableFlightCard()
        {
            InitializeComponent();
        ...
        public AvailableFlightCard(AvailableFlightDto dto, bool highlight = false) : this()
        {
            _dto = dto;
        ...
        // BIND DATA TO CARD
        // -----------------------------
        public void BindData(AvailableFlightDto dto, bool highlight)
        {
            _dto = dto;
            ...
            decimal priceInThousands = dto.Price / 1000m;
            lblPrice.Text = $"{priceInThousands:N3} VNĐ/khách";
        ...
        // -----------------------------
        private void BindSeatInfo(AvailableFlightDto dto)
        {
            pnlSeatsInfo.Controls.Clear();

            // Nếu DTO không có info chi tiết theo hạng ghế
            ...
            {
                string className = kvp.Key;  // KEY = display name
